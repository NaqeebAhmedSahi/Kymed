export const certifications = [
  ...
  },
  {
    id: 'c-iso9001',
    title: 'ISO 9001',
    short: 'Quality Management Systems',
    description:
  ...
  {
    id: 'c-scci',
    title: 'SCCI – Sialkot Chamber of Commerce & Industry',
    short: 'Corporate Membership Certification (SCCI • Pakistan)',
    description:
  ...
  {
    id: 'c-simap',
    title: 'SIMAP – Surgical Instruments Manufacturers Association of Pakistan',
    short: 'Industry Membership Certification (SIMAP • Pakistan)',
    description:
