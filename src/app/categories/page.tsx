  ...
  return (
    <section className="relative bg-[#F8F9FA] text-[#2F323A] py-24 overflow-hidden">
      ...
      >
          ...
          <div className="bg-white rounded-2xl border border-[#C4C7CA]/30 shadow-sm p-8 backdrop-blur-sm">
            ...
            >
              ...
              <div className="text-[#5D6169]">
                Showing <span className="font-semibold text-[#2F323A]">{(currentPage - 1) * itemsPerPage + 1} to {Math.min(currentPage * itemsPerPage, filteredCategories.length)}</span> of{" "}
                <span className="font-semibold text-[#2F323A]">{filteredCategories.length}</span> categories
              </div>
            </motion.div>
        ...
        {filteredCategories.length === 0 ? (
          ...
          <>
                  ...
                  >
                    ...
                    >
                      <div className="relative h-64 overflow-hidden">
                        ...
                        />
                        <div className="absolute inset-0 bg-gradient-to-t from-[#2F323A]/40 to-transparent group-hover:from-[#008C99]/20 transition-all duration-500" />
                      ...
                      <div className="p-6">
                        ...
                        <p className="text-[#5D6169] mb-4 line-clamp-2 leading-relaxed">{category.description}</p>
                        <div className="flex items-center text-[#008C99] font-semibold group-hover:text-[#006670] transition-colors duration-300">
                          Browse Products
                          <svg
            ...
            >
              {/* Results Info */}
              <div className="text-[#5D6169]">
                Showing <span className="font-semibold text-[#2F323A]">{(currentPage - 1) * itemsPerPage + 1}-{Math.min(currentPage * itemsPerPage, filteredCategories.length)}</span> of{" "}
                <span className="font-semibold text-[#2F323A]">{filteredCategories.length}</span> categories
              </div>
        ...
        >
          {[
            { number: `${categories.length}+`, label: "Product Categories", color: "from-[#008C99] to-[#006670]" },
            { number: "1000+", label: "Medical Products", color: "from-[#008C99] to-[#006670]" },
            { number: "50+", label: "Specialties Served", color: "from-[#008C99] to-[#006670]" },
          ].map((stat, index) => (
            <motion.div
              key={stat.label}
